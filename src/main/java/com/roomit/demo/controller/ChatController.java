...
public class ChatController {
    ...
    @Operation(summary = "채팅 메시지 전송", description = "roomId를 경로로, userId를 쿼리로, content를 JSON Body로 전달하여 메시지를 보냅니다.")
    ...
    @Operation(summary = "채팅 메시지 목록 조회", description = "특정 채팅방(roomId)의 모든 메시지를 반환합니다.")
